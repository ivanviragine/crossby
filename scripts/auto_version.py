#!/usr/bin/env python3
"""crossby version bump — deterministic semver version management.

Usage: python scripts/auto_version.py <patch|minor|major> [--dry-run] [--push]

Updates __version__ in src/crossby/__init__.py and version in pyproject.toml
