...
from crossby.config.claude_allowlist import configure_worktree_hooks as claude_configure_worktree_hooks
from crossby.config.copilot_hooks import configure_worktree_hooks as copilot_configure_worktree_hooks
