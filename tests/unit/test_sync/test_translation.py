...
class TestEffortClaudeToCodex:
    ...
    def test_known_pairs(
        self, model: str, effort_in: EffortLevel, effort_out: EffortLevel
    ) -> None:
...
class TestEffortCodexToClaude:
    ...
    def test_known_pairs(
        ...
        assert (
            map_effort_codex_to_claude(codex_model, None, codex_effort) == claude_effort
        )
    ...
    def test_target_model_overrides_codex_default(self) -> None:
        ...
        result = map_effort_codex_to_claude(
            "gpt-5.4-mini", "claude-haiku-4-5", EffortLevel.MEDIUM
        )
    ...
    def test_xhigh_picks_lowest_source_tier(self) -> None:
        ...
        result = map_effort_codex_to_claude(
            "gpt-5.4-mini", "claude-sonnet-4.6", EffortLevel.XHIGH
        )
